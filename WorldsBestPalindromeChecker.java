...
public class WorldsBestPalindromeChecker {
    ...
    public static boolean isPalindrome(String testString) { //Let's create a method to detect whether an input string is a palindrome or not
        
        //Convert string to lowercase and remove unwanted non-alphanumeric characters
        String updatedString = testString.replaceAll("[^a-zA-Z0-9]", "").toLowerCase();
